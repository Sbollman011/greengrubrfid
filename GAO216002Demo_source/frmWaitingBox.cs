...
namespace WinForm_Test
{
    public partial class frmWaitingBox : Form
    {
        ...
        {
            int maxWaitTime = 60*1000;
            string waitMessage = "Processing data, please waiting...";
            Initialize(method, maxWaitTime,waitMessage, cancelEnable, timerVisable);
        }
        #endregion
        ...
        */
        ...
        {
            this.Message = "Closed current action！";
            this.Close();
        }
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!this._AsyncResult.IsCompleted)
                {
                    ...
                    {
                        Message = string.Format("processing data timeout {0} seconds，stop current action！", _MaxWaitTime / 1000);
                        this.Close();
                    }
                }
                else
